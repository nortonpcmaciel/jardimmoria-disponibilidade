...
test('salvamento compartilhado, autenticação, conflitos, data e persistência', async t => {
  ...
  for (const file of ['/index.html', '/index2.html', '/atualizar.html', '/dashboard.html', '/resources/dashboard.js', '/resources/dashboard-model.js', '/resources/dashboard.css', '/resources/atualizar.js', '/resources/situacoes-sync.js'])
