(function () {
  ...
  function render() {
    ...
    $('rate').textContent = commercial ? (result.commercialized / commercial * 100).toLocaleString('pt-BR', { maximumFractionDigits: 0 }) + '%' : '—';
    ...
    $('current-growth').textContent = growth === null ? '—' : (growth > 0 ? '+' : '') + growth.toLocaleString('pt-BR',{maximumFractionDigits:0}) + '%';
